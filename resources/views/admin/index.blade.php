    ...
    <div class="form">
                ...
                <table class="table striped table-border mt-4" data-role="table" data-pagination="true"
                    ...
                    @foreach ($forums as $forum)
                        <tr>
                            ...
                            <td><a href="javascript:void(0);" onclick="location.href = '{{ url('/admin/forum/' . $forum->id . '/lock') }}';">{{ __('app.lock') }}</a></td>

                            <td>
                                <a href="javascript:void(0)" onclick="if (confirm('{{ __('app.forum_remove_confirm') }}')) location.href = '{{ url('/admin/forum/' . $forum->id . '/remove') }}';">{{ __('app.forum_remove') }}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
        ...
        <div class="modal" :class="{'is-active': bShowCreateForum}">
            ...
            <div class="modal-card">
                ...
                <section class="modal-card-body is-stretched">
                    <form method="POST" action="{{ url('/admin/forum/create') }}" id="formCreateForum">
                        @csrf
        ...
        <div class="modal" :class="{'is-active': bShowEditForum}">
            ...
            <div class="modal-card">
                ...
                <section class="modal-card-body is-stretched">
                    <form method="POST" action="{{ url('/admin/forum/edit') }}" id="formEditForum">
                        @csrf
